...
function ammendRotation(rotation) {
  var correction = 0;
...
var hrRotationCorrector = ammendRotation(0);
var minRotationCorrector = ammendRotation(0);
var secRotationCorrector = ammendRotation(0);
...
var interval = setInterval(rotateClock, 1000);
